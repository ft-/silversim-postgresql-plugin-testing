...
namespace SilverSim.Database.PostgreSQL.ServerParam
{
    [Description("PostgreSQL ServerParam Backend")]
    [PluginName("ServerParams")]
    public sealed class PostgreSQLServerParamService : ServerParamServiceInterface, IDBServiceInterface, IPlugin, IPluginShutdown
    {
        ...
        public void Startup(ConfigurationLoader loader)
        {
            using (var connection = new NpgsqlConnection(m_ConnectionString))
            {
                ...
                using (var cmd = new NpgsqlCommand("SELECT * FROM serverparams", connection))
                {
